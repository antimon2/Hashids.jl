...
@test Hashids.encodehex(config, "deadbeef") == "0dbq3jwa8p4b3gk6gb8bv21goerm96"
@test Hashids.encodehex(config, "abcdef123456") == "190obdnk4j02pajjdande7aqj628mr"
@test Hashids.encodehex(config, "ABCDDD6666DDEEEEEEEEE") == "a1nvl5d9m3yo8pj1fqag8p9pqw4dyl"
@test Hashids.encodehex(config, "507f1f77bcf86cd799439011") == "1nvlml93k3066oas3l9lr1wn1k67dy"
@test Hashids.encodehex(config, "f00000fddddddeeeee4444444ababab") == "mgyband33ye3c6jj16yq1jayh6krqjbo"
@test Hashids.encodehex(config, "abcdef123456abcdef123456abcdef123456") == "9mnwgllqg1q2tdo63yya35a9ukgl6bbn6qn8"
@test Hashids.encodehex(config, "f000000000000000000000000000000000000000000000000000f") == "edjrkn9m6o69s0ewnq5lqanqsmk6loayorlohwd963r53e63xmml29"
@test Hashids.encodehex(config, "fffffffffffffffffffffffffffffffffffffffffffffffffffff") == "grekpy53r2pjxwyjkl9aw0k3t5la1b8d5r1ex9bgeqmy93eata0eq0"
